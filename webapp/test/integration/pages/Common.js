sap.ui.define([
	...
	return Opa5.extend("com.demo.DemoUi5Project.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/demo/DemoUi5Project/localService/mockserver"], function (mockserver) {
